...
function InitLeftMenu() {
    $("#nav").accordion({ fit: true, border: false }); //animate:false,
...
{
    var s = '<iframe scrolling="auto" class="easyui-layout"  fit="true"  frameborder="0"  src="'+url+'" style="width:100%;height:100%;"></iframe>';
	return s;
}
